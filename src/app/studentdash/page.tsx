...
export default function  StudentDash(){
    return(
        ...
        <div className="flex flex-col items-center  h-screen bg-black">
           ...
           <div className="flex justify-center items-center flex-col mt-16 bg-[#F31260] p-4 rounded-2xl">
                <p>Raise a request to for red card</p>
                <button className="bg-gray-900 text-white px-4 py-2 rounded shadow mt-6">
                    Request
                </button>
           </div>
